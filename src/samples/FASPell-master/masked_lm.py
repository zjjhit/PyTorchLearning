...
class Config(object):
    ...
    bert_config = None  # modeling.BertConfig.from_json_file(bert_config_file)
    topn = 5
    bigrams = None  # pickle.load(open('bigram_dict_simplified.sav', 'rb'))

    def __init__(self, path_='./model/pre_trained/'):
        Config.bert_config = modeling.BertConfig.from_json_file(path_ + 'bert_config.json')
